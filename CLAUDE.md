...
| 现存可跑代码 | `packages/cli-registry/` · `apps/local-gateway/` · `runtime/crates/{opc-storage,opc-provider,opc-agent,opc-tool,opc-project,opc-workflow}/` · `apps/desktop/`（Tauri，IPC 已联通）|
